...
df = pd.read_csv("data/district_random.csv")
df

map = folium.Map(location=[27, 85], zoom_start=6, scrollWheelZoom=False, tiles='CartoDB positron')
    
choropleth = folium.Choropleth(
        geo_data='data/nepal-with-districts.geojson',
        data=df,
        columns=['DM','number'],
